                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/sol1.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/Sol Maria.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/solina.4.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/north coast island resort.2.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/sicogon..jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/ resort3.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                        <!-- Slide-start -->
                        <div class="swiper-slide tranding-slide">
                            <div class="tranding-slide-img">
                                <img src="image/La.jpeg" alt="Tranding">
                            </div>
                        </div>
                        <!-- Slide-end -->
                    </div>
    ...
    <div class="search-bar">
      ...
      <!-- Search Bar ends -->
        ...
        <section class="head_dv">
            <div class="head_dv">
                <div class="title">
                    <h1>"Welcome, relax and unwind!"</h1>
                </div>
            </div>
        ...
        <section class="head_dv">
            <div class="head_dv">
                <div class="title1">
                    <p>Welcome to the Carles Amusement Park, where excitement meets joy in every corner! Step into a world where laughter echoes, thrills abound, and unforgettable memories are made. From heart-pounding rides to enchanting attractions, we’ve crafted an adventure that’s perfect for everyone. Our vibrant park is designed to spark wonder and create smiles, making each visit a unique and exhilarating experience. Whether you’re here for a day of fun with family or friends, our friendly team is ready to ensure your time with us is nothing short of spectacular. Dive in, let the adventure begin, and make every moment count!</p>
                </div>
            </div>
        ...
        <section class="nt">
            <div id="container">
                <img id="image" src="image/solina.3.jpeg" />
              </div>
              <div id="container">
                <img id="image" src="image/north coast island resort.2.jpeg" />
              </div>
              <div id="container">
                <img id="image" src="image/huni.sicogon.webp" />
              </div>
        </section>
        <section class="nt">
        <div id="container">
                <img id="image" src="image/sol1.jpeg" />
              </div>
              <div id="container">
                <img id="image" src="image/isla/Balaycogon.jpeg" />
              </div>
              <div id="container">
                <img id="image" src="image/Sol Maria.jpeg" />
              </div>
        </section>
